...
/**
 * Tela exibida para assinantes do Ecossistema Completo que tentam
 * acessar o nicho isolado de Bolsas — pois o conteúdo já está incluído
 * dentro da categoria "Bolsas, Mochilas e Malas" da 25 de Março.
 */
export default function BolsasIncluded() {
        ...
        <div className="rounded-2xl border border-border/60 bg-gradient-card p-8 shadow-glow-sm">
          <div className="flex justify-center mb-4">
            <div
              ...
              style={{ backgroundImage: "linear-gradient(135deg, rgba(0,239,255,0.18), rgba(158,235,255,0.08))" }}
            >
