  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-72 bg-card border border-border rounded-xl p-4 shadow-glow"
          >
            ...
            <div className="space-y-2">
              {quickActions.map((qa) => (
                <button
                  ...
                  className="w-full text-left text-xs px-3 py-2 rounded-lg bg-muted/50 hover:bg-primary/10 hover:text-primary text-muted-foreground transition-colors"
                >
                  {qa.label}
                </button>
              ))}
      ...
      <motion.button
        ...
        className="h-14 w-14 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-glow hover:shadow-lg transition-shadow"
      >
